...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    public static class CoroutinesLibraryAccessors extends SubDependencyFactory {
        ...
        /**
         * Dependency provider for <b>play</b> with <b>org.jetbrains.kotlinx:kotlinx-coroutines-play-services</b> coordinates and
         * with version reference <b>coroutines</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getPlay() {
            return create("coroutines.play");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>firebase</b> with value <b>33.11.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>safeargs</b> with value <b>2.9.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getSafeargs() { return getVersion("safeargs"); }
    ...
    public static class HiltVersionAccessors extends VersionFactory  implements VersionNotationSupplier {
        ...
        /**
         * Version alias <b>hilt.plugin</b> with value <b>2.56.2</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getPlugin() { return getVersion("hilt.plugin"); }
    ...
    public static class PluginAccessors extends PluginFactory {
         ...
         * with version reference <b>safeargs</b>
         * <p>
         * This plugin was declared in catalog libs.versions.toml
         */
