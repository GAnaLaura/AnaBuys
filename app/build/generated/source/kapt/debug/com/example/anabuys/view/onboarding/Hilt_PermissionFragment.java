...
public abstract class Hilt_PermissionFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_PermissionFragment() {
    super();
  }

  Hilt_PermissionFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((PermissionFragment_GeneratedInjector) this.generatedComponent()).injectPermissionFragment(UnsafeCasts.<PermissionFragment>unsafeCast(this));
    }
  }
