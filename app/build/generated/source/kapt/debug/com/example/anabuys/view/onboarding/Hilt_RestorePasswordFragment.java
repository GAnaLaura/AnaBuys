...
public abstract class Hilt_RestorePasswordFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_RestorePasswordFragment() {
    super();
  }

  Hilt_RestorePasswordFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((RestorePasswordFragment_GeneratedInjector) this.generatedComponent()).injectRestorePasswordFragment(UnsafeCasts.<RestorePasswordFragment>unsafeCast(this));
    }
  }
